      ...
      <div class="container my-5">
        <div class="d-flex flex-column align-items-center">
          <div class="d-flex align-items-center justify-content-center mb-4">
            <img src="../../image/emma.png" alt="emma" class="img-fluid" style="height: 15rem;">
            <div class="text-center ps-5">
              <h1 id="nom" class="display-3">Emma</h1>
              <p class="fs-2 mb-0">@emma_44</p>
              <p class="fw-bold fs-4" id="ville">NANTES</p>
            </div>
          </div>
          <button id="btnAmi" class="btn btn-primary border mt-3 fs-5 inactive"></button>
        </div>
      </div>
