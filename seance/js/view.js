class View {
  constructor() {
    ...
    this.svgImage.src = './js/svg/return-up-back-svgrepo-com.svg';
  ...
  displayParticipants(){
    ...
    this.participantsData.forEach((participant, index) => {
      ...
      img.src = `./js/userImage/participant${index + 1}.png`; // Assuming images are named participant1.jpg, participant2.jpg, etc.
